...
class RunConfig:
    ...
    cross_attn_64_range: Range = Range(start=0, end=100) #90
    # Timesteps to apply cross-attention on 32x32 layers
    cross_attn_32_range: Range = Range(start=0, end=100) #70
    ...
    resize: bool = False
    alpha: float = 0.5
    Inject_layer: list = field(default_factory=lambda: [63,71])
